namespace System.Collections.ObjectModel {
    ...
    public class FixedObservableCollection<T> : ObservableCollection<T> {
        ...
        /// <summary>
        /// Adds an object to the end of the <see cref="FixedObservableCollection{T}"/>. Removes the first item in the collection when an item is added that exceeds the <paramref name="Capacity"/>.
        /// </summary>
